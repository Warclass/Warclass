...
\paragraph{Diseño Web Responsive}
El diseño web responsive es un enfoque de desarrollo que permite que las aplicaciones web se adapten automáticamente a diferentes tamaños de pantalla y dispositivos mediante CSS flexible, media queries y layouts fluidos. Este enfoque elimina la necesidad de aplicaciones nativas específicas para cada plataforma, permitiendo que estudiantes y docentes accedan a la plataforma educativa desde cualquier dispositivo con un navegador web moderno, sin requerir instalaciones adicionales ni actualizaciones manuales.
...
Se evalúan frameworks y enfoques para el desarrollo del frontend: React, Vue.js, Angular, Next.js y aplicación web responsive (diseño adaptativo multiplataforma).

\paragraph{Criterios de evaluación}
Curva de aprendizaje, rendimiento, ecosistema, integración 3D, compatibilidad multiplataforma.
...
Ecosistema & 4 \\
Integración 3D & 5 \\
Compatibilidad multiplataforma & 5 \\
\hline
\end{tabular}
\end{table}
\FloatBarrier
...
\hline
Criterios & React & Vue.js & Angular & Next.js & Web Responsive \\
\hline
Curva de aprendizaje & 7 & 9 & 5 & 7 & 8 \\
Rendimiento & 8 & 8 & 7 & 9 & 8 \\
Ecosistema & 9 & 7 & 8 & 9 & 9 \\
Integración 3D & 9 & 6 & 7 & 9 & 9 \\
Compatibilidad multiplataforma & 7 & 7 & 7 & 9 & 10 \\
\hline
\end{tabular}
\end{table}
\FloatBarrier
...
\hline
Criterios & Ponderación & React & Vue.js & Angular & Next.js & Web Responsive \\
\hline
Curva de aprendizaje & 4 & 7 & 9 & 5 & 7 & 8 \\
Rendimiento & 5 & 8 & 8 & 7 & 9 & 8 \\
Ecosistema & 4 & 9 & 7 & 8 & 9 & 9 \\
Integración 3D & 5 & 9 & 6 & 7 & 9 & 9 \\
Compatibilidad multiplataforma & 5 & 7 & 7 & 7 & 9 & 10 \\
\hline
Puntaje & - & 181 & 159 & 147 & 206 & 203 \\
\hline
\end{tabular}
\end{table}
\FloatBarrier
...
El enfoque de aplicación web responsive obtiene un puntaje muy cercano, destacando especialmente en compatibilidad multiplataforma al permitir acceso desde cualquier dispositivo (escritorio, tablet, smartphone) sin necesidad de instalación de aplicaciones nativas. Esta característica es crucial para maximizar la adopción institucional y eliminar barreras de acceso tecnológico.

La decisión final es implementar Next.js con diseño web responsive, combinando así las fortalezas de ambos enfoques: el framework obtiene el mejor rendimiento y capacidades técnicas, mientras que el diseño responsive garantiza accesibilidad universal desde navegadores web sin requerir descargas o instalaciones adicionales.

...
\begin{table}[H]
	...
	\begin{tabular}{p{4cm} p{9cm}}
		...
		Diseño Responsive & CSS Modules, Tailwind CSS, Media Queries \\
...
\begin{itemize}
	\item \textbf{Cliente Web Responsive}: Aplicación Next.js con App Router que sirve la interfaz web adaptativa y renderiza el entorno 3D con Three.js. Compatible con escritorio, tablets y smartphones
